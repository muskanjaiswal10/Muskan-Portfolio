  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        ...
        {
          from_name: form.name,
          to_name: "Muskan Jaiswal",
          from_email: form.email,
          to_email: "muskanjaiswal710@gmail.com",
      ...
      >
        ...
        <div className="mt-5 contact__options">
          <article className="contact__option">
            <MdEmail />
            <a href="mailto:muskanjaiswal710@gmail.com" target="_blank" className="blue-text-gradient">muskanjaiswal710@gmail.com</a>
          </article>
          <article className="contact__option">
            <BsWhatsapp />
            <a href="https://api.whatsapp.com/send/?phone=918871827750&text&app_absent=0&lang=en" target="_blank" className="blue-text-gradient">
              +91 8871827750
            </a>
          </article>
        </div>
