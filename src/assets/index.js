...
import covid19_tracker from "./covid19_tracker.png";
...
export {
  ...
  be,sql, mini, snl, linkedin,
  blog, shopping, covid19_tracker, db, walmart,
  infosys, handholding, leetcode
};
